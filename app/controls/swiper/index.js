...
export default class extends Component {
  ...
  static propTypes = {
    ...
    activePlusColor: PropTypes.string,
  }
  ...
  renderPagination = () => {
    ...
    const ActiveDot = this.props.activeDot || <View
      style={[{
        backgroundColor: this.props.activeDotColor || '#D3D3D3',
        width: 8,
        height: 8,
        borderRadius: 4,
        marginLeft: 3,
    ...
    const Dot = this.props.dot || <View
      style={[{
        backgroundColor: this.props.dotColor || 'rgb(169,169,169)',
        width: 8,
        height: 8,
        borderRadius: 4,
        marginLeft: 3,
    ...
    />;
    const ActivePlusDot = <Text style={{ color: this.props.activePlusColor, fontWeight: 'bold', fontSize: 20, marginLeft: 2, marginBottom: 5 }}>+</Text>;
    const PlusDot = <Text style={{ color: 'rgb(169,169,169)' , fontWeight: 'bold', fontSize: 20, marginLeft: 2, marginBottom: 5 }}>+</Text>;
